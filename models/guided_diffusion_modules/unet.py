...
from module_test.rcm123 import *
...
#
# import sys
# sys.path.append(r'D:\code\1115\Kaggle\P4_256_1000_123_undo_rcm123_sc\P4_256_1000_undo')
# from module_test.rcm123 import *
...
class UNet(nn.Module):
    ...
    def __init__(
        ...
        for level, mult in enumerate(channel_mults):
            for _ in range(res_blocks):
                ...
                self.skip_blocks.append(RCM(dim=ch))
    ...
    def forward(self, x, gammas):
        ...
        for module, skip in zip(self.input_blocks, self.skip_blocks):
            h = module(h, emb)
            h_skip = skip(h)
            hs.append(h_skip)
